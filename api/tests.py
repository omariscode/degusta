...
class CheckoutTests(APITestCase):
    def setUp(self):
        self.user = user_model.User.objects.create(
            email="t@t.com", name="T", phone="923000001"
        )
        self.user.set_password("pass")
        self.user.is_active = True
        self.user.save()

        self.product = product_model.Product.objects.create(
            name="P", price=10.0, stock=10
        )
    ...
    def test_checkout_and_my_orders(self):
        ...
        checkout_payload = {
            ...
            "items": [{"product": self.product.id, "qty": 2}],
        }
